...
REPLACEMENTS = [
    ...
    # Double rank level suffix cleanups
    ("ချီစုစည်းမှုအဆင့်အဆင့်", "ချီစုစည်းမှုအဆင့်"),
    ("အခြေတည်အဆင့်အဆင့်", "အခြေတည်အဆင့်"),
    ("ရွှေအမြုတေအဆင့်အဆင့်", "ရွှေအမြုတေအဆင့်"),
    ("နတ်သူငယ်အဆင့်အဆင့်", "နတ်သူငယ်အဆင့်"),
    ("ဝိညာဉ်ဖွဲ့စည်းခြင်းအဆင့်အဆင့်", "ဝိညာဉ်ဖွဲ့စည်းခြင်းအဆင့်"),
    ("ဝိညာဉ်အသွင်ပြောင်းခြင်းအဆင့်အဆင့်", "ဝိညာဉ်အသွင်ပြောင်းခြင်းအဆင့်"),
    ("နိဗ္ဗာန်အားမေးမြန်းခြင်းအဆင့်အဆင့်", "နိဗ္ဗာန်အားမေးမြန်းခြင်းအဆင့်"),
    ("တက်လှမ်းခြင်းအဆင့်အဆင့်", "တက်လှမ်းခြင်းအဆင့်"),
]
